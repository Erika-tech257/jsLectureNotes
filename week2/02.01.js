...
// of requires that your "thing" you're looping through be iterable--that means 
...
let catArray = ['tabby','british shorthair','brumese','maine coon','rag doll'];
...
/* PLATINUM
    - Convert the conditional into a ternary (shorthand operator to writing a conditional)
*/
...
// dot notation
console.log(fellowshipOfTheRing.memebers.Gandalf) ? //staff

for (let character in fellowshipOfTheRing.members) {
    console.log(character);
}
// object bracket notation / property assessors
console.log(fellowshipOfTheRing[memebrs]);
...
let fellowshipOfTheRing = {
    ...
    for (let character in fellowshipOfTheRing['memebers']) {
        console.log(character);
